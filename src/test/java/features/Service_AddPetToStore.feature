Feature: Add Pet to store
  ...
  Scenario Outline: Add new pet to store's catalog with valid pet details
    ...
    Examples:
      ...
      |TC_02_Add_Pet_To_Store_with_Json_input|ADD_PET  |200                 |
      |TC_01_Add_Pet_To_Store_with_XML_input |ADD_PET  |200                 |
  ...
  Scenario Outline: Add new pet to store's catalog with Invalid pet details
    ...
    Examples:
      |Unique_Test_Case_ID                                            |SheetName|ExpectedResponseCode|
      |TC_03_Add_Pet_Json_Invalid_Details_MissingHeader_accept        |ADD_PET  |400                 |
      |TC_04_Add_Pet_Json_Invalid_Details_MissingHeader_content-type  |ADD_PET  |400                 |
      |TC_05_Add_Pet_Json_Invalid_Details_wrong_PetStatus             |ADD_PET  |405                 |
